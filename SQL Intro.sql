...
SELECT * FROM Employees WHERE MiddleInitial IS null; -- find all employees who don't have a middle initial
...
SELECT * FROM Products WHERE StockLevel BETWEEN 500 AND 1200 ORDER BY Price; -- find all products from the products table whose stock level is in the range -- of 500 to 1200. Order by Price from least to greatest. Hint: Use the between keyword